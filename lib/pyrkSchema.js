				...
				else
				{
					...
					if (contractData.transactiontype == 'GENESIS')
					{
						...
						*/
						...
						var tidpart2 = blockData.hash.substr(0,9);
					...
					else if (contractData.tp == 'RESUME')
					{
					...
					else if (contractData.tp == 'NEWOWNER')
					{
